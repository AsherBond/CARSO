...
def main_parse() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=5120,
        metavar="<batch_size>",
        help="Batch size for training (default: 5120)",
    )
    parser.add_argument(
        "--advfrac",
        type=float,
...
def main_run(args: argparse.Namespace) -> None:
    ...
    load_model(vanilla_classifier, "../models/cifar10_linf_wrn28-10_with.safetensors")
    # noinspection DuplicatedCode
